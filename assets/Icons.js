...
const Swimming = (props) => {
  const SwimIcon = `<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        width="31.39px" height="31.39px" viewBox="0 0 31.39 31.39" style="enable-background:new 0 0 31.39 31.39;" xml:space="preserve"
       >
    <g>
       <g>
  ...
  const SwimSVG = () => (
    <SvgXml fill={props.color} xml={SwimIcon} width="75%" height="75%" />
  );
